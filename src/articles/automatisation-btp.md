...
<span id="generation-automatique-devis"></span>
...
1. Le client remplit un **formulaire en ligne** (type de travaux, surface, adresse)
2. Make récupère les informations automatiquement
3. Un devis PDF est **généré en quelques secondes** depuis votre modèle
4. Le devis est envoyé par email au client **avec votre signature**
5. Une relance automatique est programmée si pas de réponse sous 48h
...
<span id="par-ou-commencer"></span>
## Par où commencer ?

L'erreur classique est de vouloir tout automatiser d'un coup. La bonne approche :

1. **Identifier la tâche la plus chronophage** de votre semaine
2. **Automatiser uniquement celle-là** en premier
3. **Mesurer le gain** sur 4 semaines
